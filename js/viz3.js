...
var $gicentre$elm_vegalite$VegaLite$Column = 0;
var $gicentre$elm_vegalite$VegaLite$arColumn = 0;
var $gicentre$elm_vegalite$VegaLite$Row = 1;
var $gicentre$elm_vegalite$VegaLite$arRow = 1;
...
var $gicentre$elm_vegalite$VegaLite$point = $gicentre$elm_vegalite$VegaLite$mark(10);
...
var $gicentre$elm_vegalite$VegaLite$VLRepeat = 21;
...
var $gicentre$elm_vegalite$VegaLite$VLSpec = 23;
	...
	var trans = A2(
		...
		A2(
			...
			A2(
				...
				$gicentre$elm_vegalite$VegaLite$filter(
					$gicentre$elm_vegalite$VegaLite$fiExpr('datum.minDate > -1000'))),
			$gicentre$elm_vegalite$VegaLite$filter(
				$gicentre$elm_vegalite$VegaLite$fiExpr('datum.maxDate < 2000'))),
		$gicentre$elm_vegalite$VegaLite$filter(
	...
	var spec = $gicentre$elm_vegalite$VegaLite$asSpec(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$gicentre$elm_vegalite$VegaLite$maOpacity(0.1)
					])),
				trans(_List_Nil)
			]));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							['reprLat', 'reprLong', 'maxDate', 'minDate'])),
						$gicentre$elm_vegalite$VegaLite$columnFields(
						_List_fromArray(
							['minDate', 'maxDate', 'reprLong', 'reprLat']))
					])),
				$gicentre$elm_vegalite$VegaLite$specification(spec)
			]));
}();
