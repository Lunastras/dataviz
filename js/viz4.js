...
var $gicentre$elm_vegalite$VegaLite$Boxplot = 3;
...
var $gicentre$elm_vegalite$VegaLite$boxplot = $gicentre$elm_vegalite$VegaLite$mark(3);
...
var $gicentre$elm_vegalite$VegaLite$MBox = function (a) {
	return {$: 8, a: a};
};
var $gicentre$elm_vegalite$VegaLite$maBox = $gicentre$elm_vegalite$VegaLite$MBox;
...
var $gicentre$elm_vegalite$VegaLite$MOutliers = function (a) {
	return {$: 43, a: a};
};
var $gicentre$elm_vegalite$VegaLite$maOutliers = $gicentre$elm_vegalite$VegaLite$MOutliers;
...
var $gicentre$elm_vegalite$VegaLite$MTicks = function (a) {
	return {$: 68, a: a};
};
var $gicentre$elm_vegalite$VegaLite$maTicks = $gicentre$elm_vegalite$VegaLite$MTicks;
...
var $gicentre$elm_vegalite$VegaLite$VLVConcat = 19;
	...
	var trans = A2(
		...
		A2(
			...
			$gicentre$elm_vegalite$VegaLite$filter(
				$gicentre$elm_vegalite$VegaLite$fiExpr('datum.reprLong < 1000'))),
		$gicentre$elm_vegalite$VegaLite$filter(
			$gicentre$elm_vegalite$VegaLite$fiExpr('datum.reprLat < 1000')));
	var sel = A2(
		$elm$core$Basics$composeL,
		...
		A3(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($gicentre$elm_vegalite$VegaLite$iText, 'timePeriodsKeys', _List_Nil)
						]))
				])));
	...
	var encLong = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$gicentre$elm_vegalite$VegaLite$pName('featureType'),
					...
					[
						...
						_List_fromArray(
							[
								...
								$gicentre$elm_vegalite$VegaLite$boxplot(
								_List_fromArray(
									[
										$gicentre$elm_vegalite$VegaLite$maTicks(
										_List_fromArray(
											[
												$gicentre$elm_vegalite$VegaLite$maColor('black'),
												$gicentre$elm_vegalite$VegaLite$maSize(8)
											])),
										$gicentre$elm_vegalite$VegaLite$maBox(
										_List_fromArray(
											[
												$gicentre$elm_vegalite$VegaLite$maFill('grey')
											])),
										$gicentre$elm_vegalite$VegaLite$maOutliers(
										_List_fromArray(
											[
												$gicentre$elm_vegalite$VegaLite$maColor('firebrick')
											]))
									])),
								trans(_List_Nil),
								sel(_List_Nil),
